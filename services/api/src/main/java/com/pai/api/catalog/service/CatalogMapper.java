...
public class CatalogMapper {
    ...
    public OptionResponse toGlobalOption(VaccineOptionEntity x) {
        return new OptionResponse(
                x.getId(), x.getVaccineId(), null, x.getFieldType(), x.getValue(), x.getDisplayName(),
                x.getSortOrder(), x.isDefault(), x.isActive(), null, x.getVersion());
    }
    ...
    public OptionResponse toInstitutionOption(InstitutionVaccineOptionEntity x, UUID vaccineId, UUID institutionId) {
        return new OptionResponse(
                x.getId(), vaccineId, institutionId, x.getFieldType(), x.getValue(), x.getDisplayName(),
                x.getSortOrder(), x.isDefault(), x.isActive(), x.getSourceTemplateId(), x.getVersion());
    }

    public OptionResponse toSuggestedOption(VaccineOptionTemplateEntity template, UUID vaccineId, UUID institutionId) {
        return new OptionResponse(
                template.getId(),
                vaccineId,
                institutionId,
