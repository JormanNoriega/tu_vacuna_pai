...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserNotActive(UserNotActiveException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new ErrorResponse("USER_NOT_ACTIVE", ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleRoleNotFound(RoleNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse("ROLE_NOT_FOUND", ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleScopeViolation(ScopeViolationException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(new ErrorResponse("SCOPE_VIOLATION", ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleAttentionNotFound(AttentionNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
    ...
    public ResponseEntity<ErrorResponse> handleDoseNotFound(DoseNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse("DOSE_NOT_FOUND", ex.getMessage()));
    }

    @ExceptionHandler(InvalidClinicalStateException.class)
    public ResponseEntity<ErrorResponse> handleInvalidClinicalState(InvalidClinicalStateException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ErrorResponse("INVALID_STATE", ex.getMessage()));
    }
