...
public record PatientResponse(
    ...
    public record DemographicDto(String gender, String ethnicity, String sexualOrientation, String educationLevel) {}
    ...
    public record AffiliationDto(String affiliationRegime, String insurer) {}
