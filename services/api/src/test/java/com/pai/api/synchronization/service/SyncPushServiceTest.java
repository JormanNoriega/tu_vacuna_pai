...
class SyncPushServiceTest {
  ...
  private SyncOperation attentionOperation(
      UUID operationId, UUID aggregateId, List<UUID> dependencies) {
    return new SyncOperation(
        operationId,
        "CREATE_ATTENTION",
        aggregateId,
  ...
  void rejects_operation_without_accepted_dependency() {
    ...
    SyncPushResponse response = service.push(
        ACTOR_ID,
        new SyncPushRequest(
            List.of(attentionOperation(operationId, UUID.randomUUID(), List.of(dependencyId)))));
  ...
  void replays_same_operation_id_returns_original_response() {
    ...
    SyncPushResponse response = service.push(
        ACTOR_ID, new SyncPushRequest(List.of(patientOperation(operationId, List.of()))));
  ...
  void permission_denied_rejects_operation() {
    ...
    SyncPushResponse response = service.push(
        ACTOR_ID,
        new SyncPushRequest(
            List.of(attentionOperation(operationId, UUID.randomUUID(), List.of()))));
